...
| Gate 1 | Data & universe layer (point-in-time, dual masks, sector map, circuit filter, gate-zero integrity) | ◐ green — built + integrity/leakage green; holding, uncommitted pending review |
